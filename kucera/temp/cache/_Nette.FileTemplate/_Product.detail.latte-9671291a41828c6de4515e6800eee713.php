<?php //netteCache[01]000401a:2:{s:4:"time";s:21:"0.48919600 1354639488";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:79:"C:\server\www\pokusy\test\kucera\app\AdminModule\templates\Product\detail.latte";i:2;i:1341166641;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"6a33aa6 released on 2012-10-01";}}}?><?php

// source file: C:\server\www\pokusy\test\kucera\app\AdminModule\templates\Product\detail.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'oyvpl4f100')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdc4dc03b04_content')) { function _lbdc4dc03b04_content($_l, $_args) { extract($_args)
?><div id="detail">
...
<div id="dialog">
<?php Nette\Latte\Macros\FormMacros::renderFormBegin($form = $_form = (is_object("editProduct") ? "editProduct" : $_control["editProduct"]), array('class' => 'ajax')) ;if (is_object($form)) $_ctrl = $form; else $_ctrl = $_control->getComponent($form); if ($_ctrl instanceof Nette\Application\UI\IRenderable) $_ctrl->validateControl(); $_ctrl->render('errors') ?>
    <div class="pair">
